...
while (P < 1000000) {
    ...
    if (isPrime) {
        ...
        let rotationCache = [];
        let pStrRotation = pString;
        let rotIsPrime = false;
        //run
        do {
        ...
        if (rotIsPrime) {
            ...
            rotationCache.forEach(rotationvalue => {
                if (RotationPrimes.indexOf(rotationvalue) < 0)
                    RotationPrimes.push(rotationvalue);
            });
...
//# sourceMappingURL=circularprimes.js.map