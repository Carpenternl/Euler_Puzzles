    ...
    public static decimal calculate()
    {
        ...
        while (beta < 100) // B<100
        {
            ...
            while (alpha < beta) // A<B
            {
                ...
                var a1b0 = a1 / b0;
                var a0b1 = a0 / b1;
                var fractionAlpha = a1b0 == alpha / beta && a0==b1;
                if (fractionAlpha)
                {
                    fractionSum *=(alpha / beta);
                    Console.Write($"({alpha}/{beta})={alpha / beta}| {a1}/{b0}={a1b0} \n");
                }
                var FractionBeta = a0b1 == alpha / beta && a1==b0;
                if (FractionBeta)
                {
                    fractionSum *=(alpha / beta);
        ...
        Console.WriteLine($"answer: {1/fractionSum}");
        return 1/fractionSum;
    }
}